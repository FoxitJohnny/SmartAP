...
SEED_VENDORS = [
    Vendor(
        ...
        onboarded_date=datetime.now() - timedelta(days=730),
    ...
    Vendor(
        ...
        risk_profile=VendorRiskProfile(
            ...
            invoice_count=87,
            avg_invoice_amount=3500.00,
            max_invoice_amount=15000.00,
            has_fraud_history=False,
            last_payment_date=datetime.now() - timedelta(days=12),
            days_since_last_payment=12,
        ),
        onboarded_date=datetime.now() - timedelta(days=365),
    ...
    Vendor(
        ...
        risk_profile=VendorRiskProfile(
            ...
            invoice_count=320,
            avg_invoice_amount=450.00,
            max_invoice_amount=2000.00,
            has_fraud_history=False,
            last_payment_date=datetime.now() - timedelta(days=3),
            days_since_last_payment=3,
        ),
        onboarded_date=datetime.now() - timedelta(days=1095),
    ...
    Vendor(
        ...
        onboarded_date=datetime.now() - timedelta(days=180),
    ...
    Vendor(
        ...
        risk_profile=VendorRiskProfile(
            ...
            max_invoice_amount=12000.00,
            has_fraud_history=False,
            last_payment_date=datetime.now() - timedelta(days=7),
            days_since_last_payment=7,
        ),
        onboarded_date=datetime.now() - timedelta(days=540),
    ...
    Vendor(
        ...
        risk_profile=VendorRiskProfile(
            risk_score=0.22,
            on_time_payment_rate=0.89,
            invoice_count=203,
            avg_invoice_amount=280.00,
            max_invoice_amount=1200.00,
            has_fraud_history=False,
            last_payment_date=datetime.now() - timedelta(days=2),
    ...
    Vendor(
        ...
        onboarded_date=datetime.now() - timedelta(days=5),
        notes="PENDING: Awaiting first invoice",
    ),
    Vendor(
        vendor_id="V010",
        ...
        risk_profile=VendorRiskProfile(
            ...
            has_fraud_history=False,
            last_payment_date=datetime.now() - timedelta(days=18),
            days_since_last_payment=18,
        ),
        onboarded_date=datetime.now() - timedelta(days=300),
...
SEED_PURCHASE_ORDERS = [
    ...
    PurchaseOrder(
        ...
        expected_delivery=datetime.now() - timedelta(days=25),
    ...
    PurchaseOrder(
        ...
        vendor_id="V007",
        created_date=datetime.now() - timedelta(days=35),
        expected_delivery=datetime.now() - timedelta(days=20),
        status=POStatus.CLOSED,
        currency="USD",
        subtotal=3500.00,
...
SEED_PURCHASE_ORDERS.extend([
    PurchaseOrder(
        ...
        expected_delivery=datetime.now() + timedelta(days=27),
        status=POStatus.OPEN,
        currency="USD",
        subtotal=850.00,
        tax=68.00,
